...
---
### Дополнение
### !!! обрати внимание алгоритм поведения
- должен быть реализован следующий алгоритм принятия решения!
1. считаем требуемый размер данных 
2. Проверяем сколько свободно
3. Мы можем использовать 70% от свободной (70% - параметр что бы мохжно было задавать из вне программно)
4. если не проходим работаем пачками из N лучей антен 
5. считаем сколько байт в одной антене и сколько может поместиться в этот размер и на базе этого создаем кол-во batch 
6. Если остаемся [1..3] антенны добавляем в последний batch
