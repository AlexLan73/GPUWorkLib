...
|---|------|-----------|-------------|--------|
| 01 | [TASK_Python_01_common_runner.md](TASK_Python_01_common_runner.md) | `TestRunner` + `SkipTest` (инфраструктура) | — | ✅ DONE |
| 02 | [TASK_Python_02_data_validator.md](TASK_Python_02_data_validator.md) | `DataValidator` — один класс вместо 4 | — | ✅ DONE |
| 03 | [TASK_Python_03_numpy_reference.md](TASK_Python_03_numpy_reference.md) | `NumpyReference` — CPU-эталон pipeline | — | ✅ DONE |
| 04 | [TASK_Python_04_signal_factory.md](TASK_Python_04_signal_factory.md) | `ISignalSource` + 5 вариантов + Factory | 01 | ✅ DONE |
| 05 | [TASK_Python_05_pipeline_step_validator.md](TASK_Python_05_pipeline_step_validator.md) | `PipelineStepValidator` — 9 шагов, 14 CHECK | 02, 03 | ✅ DONE |
| 06 | [TASK_Python_06_test_strategies.md](TASK_Python_06_test_strategies.md) | `TestStrategiesPipeline` — 5 тестов (V1–V5) | 01–05 | ✅ DONE |
| 07 | [TASK_Python_07_remove_pytest_strategies.md](TASK_Python_07_remove_pytest_strategies.md) | Убрать pytest из `strategies/` (9 файлов) | 01, 02 | ✅ DONE |
| 08 | [TASK_Python_08_remove_pytest_all_modules.md](TASK_Python_08_remove_pytest_all_modules.md) | Убрать pytest из всех остальных модулей | 01, 02 | ✅ DONE |
