...
struct Search3Params {
    ...
    Search3Params()
        ...
        , max_peaks_count(1)
        , task_id("search_3")
        , module_name("search_3_module")
    {}
    
    /**
     * @brief Конструктор с параметрами
     */
    Search3Params(size_t beams, size_t points, size_t out_points, size_t max_peaks,
                  const std::string& task = "search_3", const std::string& module = "search_3_module")
        : beam_count(beams)
        , count_points(points)
