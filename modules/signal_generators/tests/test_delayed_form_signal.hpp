...
// ════════════════════════════════════════════════════════════════════════════
// Built-in Lagrange matrix — идентична kBuiltinLagrangeMatrix в lch_farrow.cpp
// Плоский массив [48 * 5]: строка i = коэффициенты для mu = i/48
// ════════════════════════════════════════════════════════════════════════════
...
inline std::vector<std::complex<float>> ApplyDelayRef(
  ...
  for (int n = 0; n < N; ++n) {
    ...
    const float* L = kLagrangeMatrix + row * 5;
